document.addEventListener("DOMContentLoaded", function () {
    ...
    imgZoomWrappers.forEach(wrapper => {
        const baseItem = wrapper.querySelector(".img--base") as HTMLImageElement;
        const zoomedItem = wrapper.querySelector(".img--zoom") as HTMLImageElement;
        const zoomCover = wrapper.querySelector(".zoom-cover") as HTMLElement;
    ...
    function addZoomImageBehavior(baseItem: HTMLImageElement, cover: HTMLElement, zoomedItem: HTMLImageElement, scale: number) {

        if (!zoomedItem.parentElement) throw new Error("Zoomed Item must be wrapped");
        if (!baseItem.parentElement) throw new Error("Base Item Must have a wrapper");
        ...
        function addMoveoverBaseItemBehavior() {
            ...
            function dragEvent(this: Document, e: MouseEvent) {
                let top;
                let left;
