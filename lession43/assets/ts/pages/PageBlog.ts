...
export class PageBlog extends PageAbstract {
    ...
    postListEl: HTMLElement;
    postEditorEl: PostEditor;
    appInfinityEl: HTMLElement;
    ...
    async beforeRender(): Promise<void> {
        if (this.isFirstRender) {
            ...
            this.indicatorEl = this.querySelector(".loading-indicator") as HTMLElement;
            this.postListEl = this.querySelector(".post-list") as HTMLElement;
            this.appInfinityEl = this.querySelector("app-infinity-scroll") as AppInfinityScroll;
            this.postEditorEl = this.querySelector("post-editor") as PostEditor;
