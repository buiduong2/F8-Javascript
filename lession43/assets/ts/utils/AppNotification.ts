export class AppNotification extends HTMLElement {
    ...
    createNotification(type: string, message: string): HTMLElement {
        ...
        const btn = notification.querySelector(".btn-remove") as HTMLElement;
    ...
    removeNotification(el: HTMLElement) {

        clearTimeout((el as any).$timeoutId)
