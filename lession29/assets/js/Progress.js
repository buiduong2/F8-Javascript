export function Progress(el, duration, current, state) {
...
Progress.prototype.computeTime = function (second) {
	var min = String(Math.floor(second / 60))
	var remainSecond = String(Math.floor(second % 60))
	return `${min.padStart(2, '0')}:${remainSecond.padStart(2, '0')}`
}
