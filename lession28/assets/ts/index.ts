var carouselInnerEl = document.querySelector(".carousel .carousel-inner") as HTMLElement;
var slideItemEls = document.querySelectorAll(".carousel .item");
var nextBtnEl = document.querySelector(".carousel .carousel-nav .next") as HTMLButtonElement;
var prevBtnEl = document.querySelector(".carousel .carousel-nav .prev") as HTMLButtonElement;
var carouselBtnListEl = document.querySelector(".carousel .carousel-button-list") as HTMLElement;
...
var itemDatas: ItemData[] = Array.from(carouselInnerEl.children)
...
var slideBtns: SlideBtn[] = Array.from(carouselBtnListEl.children)
    .map(function (btn, index) {
        return {
            id: index,
            el: btn as HTMLButtonElement
        }
    })
...
function changeSlide(index: number, force?: boolean): void {
...
carouselInnerEl.onmousedown = function (mouseDwEv) {
    ...
    var currentTranslateX: number = itemDatas[currentIndex].translateX;
