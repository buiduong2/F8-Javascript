...
import { PlayPage, type PlayPageProp } from "./PagePlay.js";

export class CountDownPage extends QuizzPage<PlayPageProp> {
    ...
    constructor(app: QuizzApp, prop: any) {
        ...
        this.audioBegin = document.querySelector("#begin-sound-effect") as HTMLAudioElement;
    }
