...
export class PlayPage extends QuizzPage<PlayPageProp> {
    ...
    static createMessageEl(): HTMLElement {
...
class GameStatsManager {
    ...
    moute() {
        (this.currentQuestionEl.querySelector(".total") as HTMLElement).textContent = String(this.totalQuestion);
    ...
    increaseStreak() {
        ...
        if (this.currentStreak <= this.maxStreak) {
            const progressEl = this.streakEl.querySelector(".streak-progress .current") as HTMLElement;
        ...
        const progressNumber = this.streakEl.querySelector(".streak-number .current") as HTMLElement;
    ...
    resetStreak() {
        this.currentStreak = 0;
        const progressBar = this.streakEl.querySelector(".streak-progress .current") as HTMLElement;
...
class FeedbackManager {
    msgWrapperEl: HTMLElement

    constructor(msgWrapperEl: HTMLElement) {
