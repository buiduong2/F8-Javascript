...
import { PostRes, UserRes } from "../types/type.js";
...
export class PageProfile extends PageAbstract {
    ...
    setHTML(user: UserRes, pageOwner: boolean): void {
        this.innerHTML =
            `
        <div class="flex-grid">
    ...
    addPost(userRes: UserRes): void {
        const postListEl = this.querySelector(".post-list") as HTMLElement;

        const posts: PostRes[] = userRes.blogs.map(blog => {
            return {
                ...blog,
